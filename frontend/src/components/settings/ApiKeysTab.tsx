...
import { Table, Button, Space, Tag, Typography, Popconfirm, message, Tooltip, Modal, Alert } from 'antd';
import {
    PlusOutlined,
    EditOutlined,
    DeleteOutlined,
...
export default function ApiKeysTab() {
    ...
    const columns: ColumnsType<APIKey> = [
        ...
        },
        {
            ...
            key: 'rate_limit',
            width: 100,
            render: (_, record) => <Text>{record.rate_limit}/min</Text>,
        },
        {
            title: 'Expires',
            key: 'expires_at',
                ...
                <Space>
                    ...
                    >
                        <Tooltip title='Rotate key'>
                            <Button size='small' icon={<SyncOutlined />} loading={rotateMutation.isPending} />
                        </Tooltip>
                    </Popconfirm>
    ...
    return (
        <div>
            ...
            <Table columns={columns} dataSource={apiKeys || []} rowKey='id' loading={isLoading} pagination={false} />

            <ApiKeyModal apiKey={selectedKey} isCreating={isCreating} open={modalOpen} onClose={handleModalClose} />
