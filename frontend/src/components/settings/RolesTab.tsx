...
import { Table, Button, Space, Tag, Typography, Popconfirm, message, Tooltip } from 'antd';
import { PlusOutlined, EditOutlined, DeleteOutlined, UndoOutlined, LockOutlined } from '@ant-design/icons';
...
export default function RolesTab() {
                    ...
                    {record.is_system ? (
                        ...
                        >
                            <Tooltip title='Reset to defaults'>
                                <Button size='small' icon={<UndoOutlined />} loading={resetMutation.isPending} />
                            </Tooltip>
                        </Popconfirm>
                    ) : (
                        <Popconfirm
    ...
    return (
        <div>
            ...
            <RoleModal role={selectedRole} isCreating={isCreating} open={modalOpen} onClose={handleModalClose} />
        </div>
    );
}
