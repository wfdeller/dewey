...
import { Modal, Form, Input, Checkbox, Collapse, Space, Alert, message, Spin, Typography } from 'antd';
import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query';
import { rolesService, Role, RoleCreateRequest, RoleUpdateRequest, PermissionInfo } from '../../services/usersService';
...
export default function RoleModal({ role, isCreating, open, onClose }: RoleModalProps) {
    ...
    const permissionsByCategory = useMemo(() => {
        ...
        return permissionsData.permissions.reduce((acc: Record<string, PermissionInfo[]>, perm: PermissionInfo) => {
                ...
                items={categories.map((category) => ({
                    ...
                    label: (
                        <Space>
                            ...
                            <Text type='secondary'>({permissionsByCategory[category].length} permissions)</Text>
                        </Space>
                    ),
                    children: (
                        <Form.Item
    ...
    return (
        ...
        >
            <Form form={form} layout='vertical'>
                ...
                >
                    <TextArea placeholder='Describe what this role is for...' rows={2} showCount maxLength={255} />
                </Form.Item>
