...
export default function EmailTab() {
    ...
    return (
        <div>
            ...
            {config?.last_error && (
                <Alert type='error' message='Last Error' description={config.last_error} style={{ marginBottom: 24 }} />
            )}
            ...
            >
                <Card title='Provider Selection' style={{ marginBottom: 24 }}>
                    ...
                    >
                        <Select size='large' onChange={(value) => setSelectedProvider(value as EmailProvider)}>
                ...
                {selectedProvider === 'smtp' && (
                    ...
                    >
                        ...
                        <Row gutter={16}>
                            <Col span={12}>
                                <Form.Item name='smtp_use_tls' label='Use TLS (STARTTLS)' valuePropName='checked'>
                                    <Switch />
                                </Form.Item>
                            </Col>
                            <Col span={12}>
                                <Form.Item name='smtp_use_ssl' label='Use SSL/TLS (Implicit)' valuePropName='checked'>
                                    <Switch />
                                </Form.Item>
                            </Col>
                        </Row>
                ...
                <Card title='Settings' style={{ marginBottom: 24 }}>
                    <Row gutter={16}>
                        ...
                        <Col span={12}>
                            <Form.Item name='is_active' label='Enable Email Sending' valuePropName='checked'>
                                <Switch />
                            </Form.Item>
                        </Col>
                    </Row>
                ...
                <Space>
                    <Button type='primary' size='large' onClick={handleSave} loading={saveMutation.isPending}>
                        Save Configuration
                    </Button>

                    {config && (
                        <Button size='large' icon={<SendOutlined />} onClick={() => setTestModalVisible(true)}>
                            Send Test Email
                        </Button>
                    )}
                </Space>
            ...
            <Modal
                ...
                okText='Send Test'
            >
                <Paragraph>Send a test email to verify your configuration is working correctly.</Paragraph>
