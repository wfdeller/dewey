...
import { Drawer, Form, Input, Switch, Button, Space, Divider, InputNumber, Select, Typography } from 'antd';
...
export default function FieldPropertyDrawer({ open, field, onClose, onSave, loading }: FieldPropertyDrawerProps) {
            ...
            {field && (
                <Form form={form} layout='vertical'>
                    ...
                    <Form.Item name='help_text' label='Help Text'>
                        <Input.TextArea rows={2} placeholder='Additional instructions for the user' />
                    </Form.Item>
