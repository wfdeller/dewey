...
export default function FormPreview({ form: formData, fields, onSubmit, isEmbedded = false }: FormPreviewProps) {
        ...
        <div style={containerStyle}>
            ...
            >
                ...
                <div style={{ marginBottom: 24 }}>
                    ...
                    {formData.description && <Paragraph type='secondary'>{formData.description}</Paragraph>}
                </div>
