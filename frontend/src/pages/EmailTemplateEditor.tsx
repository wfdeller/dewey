            ...
            >
                                ...
                                children: (
                                    <>
                                        ...
                                        <Row gutter={16}>
                                            ...
                                            <Col span={12}>
                                                <Form.Item name='formLinkExpiresDays' label='Link Expiry (days)'>
                ...
                <div style={{ marginTop: 24 }}>
                    ...
                    <Space direction='vertical' size={4}>
                        <Text type='secondary'>Sends: {template.send_count.toLocaleString()}</Text>
                        <Text type='secondary'>
                            Last sent:{' '}
                            {template.last_sent_at ? new Date(template.last_sent_at).toLocaleString() : 'Never'}
                        </Text>
                        <Text type='secondary'>Created: {new Date(template.created_at).toLocaleDateString()}</Text>
                        <Text type='secondary'>Updated: {new Date(template.updated_at).toLocaleDateString()}</Text>
                    </Space>
                </div>
            </Drawer>
