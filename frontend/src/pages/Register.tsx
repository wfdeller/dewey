...
import { MailOutlined, LockOutlined, UserOutlined, BankOutlined, LinkOutlined } from '@ant-design/icons';
...
export default function Register() {
    ...
    return (
        <div>
            ...
            <Form form={form} name='register' onFinish={handleSubmit} layout='vertical' size='large'>
                ...
                >
                    <Input prefix={<LinkOutlined />} placeholder='organization-slug' addonBefore='dewey.app/' />
                </Form.Item>
