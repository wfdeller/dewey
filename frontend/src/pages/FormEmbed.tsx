        ...
        items={[
          {
            ...
            children: (
              <Card>
                <Paragraph>
                  Share this link directly with your audience. They can fill out the form
                  on a dedicated page hosted by Dewey.
                </Paragraph>
          ...
          },
          {
            ...
            children: (
              <Card>
                <Paragraph>
                  Embed the form on your website using an iFrame. This is the simplest
                  embedding method and works with any website.
                </Paragraph>
          ...
          },
          {
            ...
            children: (
              <Card>
                <Paragraph>
                  Embed the form using our JavaScript widget. This provides a more
                  seamless integration and automatically adjusts to your page's styling.
                </Paragraph>
                ...
                <Text type="secondary">
                  Add this code anywhere on your page where you want the form to appear.
                  The script will automatically render the form in place of the div element.
                </Text>
              </Card>
            ),
          },
