...
import { Card, Descriptions, Tag, Spin, Alert, Button, Row, Col, Divider, Typography, Space } from 'antd';
...
John Doe`,
        ...
        analysis: {
            ...
            summary:
                'Long-time customer inquiring about account discrepancies including service charges, subscription changes, and a pending refund. Tone is polite and constructive.',
            entities: [
            ...
            suggestedResponse:
                "Thank you for reaching out regarding your account. We appreciate your 5 years of loyalty. I'd be happy to review the charges and adjustments you mentioned. Let me look into your account and I'll provide a detailed response within 24 hours.",
            urgencyScore: 0.45,
            aiProvider: 'claude',
    ...
    return (
        <div>
            <Button icon={<ArrowLeftOutlined />} onClick={() => navigate('/messages')} style={{ marginBottom: 16 }}>
                Back to Messages
            </Button>
                    ...
                    <Card>
                        ...
                        <Descriptions column={2} style={{ marginBottom: 24 }}>
                            ...
                            <Descriptions.Item label='Status'>
                                <Tag
                                    color={displayMessage.processing_status === 'completed' ? 'success' : 'processing'}
                                >
                        ...
                        <div style={{ whiteSpace: 'pre-wrap', lineHeight: 1.8 }}>{displayMessage.body_text}</div>
                    </Card>
                </Col>
