...
import { Table, Tag, Space, Input, Select, DatePicker, Button, Card, Row, Col } from 'antd';
    ...
    const columns: ColumnsType<Message> = [
        {
            ...
            key: 'subject',
            ellipsis: true,
            render: (text: string, record: Message) => <a onClick={() => navigate(`/messages/${record.id}`)}>{text}</a>,
        },
        {
            title: 'Sender',
            ...
            ellipsis: true,
            width: 200,
            render: (email: string, record: Message) => <span>{record.sender_name || email}</span>,
        },
        {
            title: 'Source',
            dataIndex: 'source',
            key: 'source',
            width: 100,
            render: (source: MessageSource) => <Tag color={sourceColors[source]}>{source.toUpperCase()}</Tag>,
        },
        {
            title: 'Sentiment',
            key: 'sentiment',
            ...
            render: (_: unknown, record: Message) => {
                ...
                return <Tag color={sentimentColors[label]}>{label.charAt(0).toUpperCase() + label.slice(1)}</Tag>;
            },
        },
        {
            title: 'Campaign',
            ...
            width: 100,
            render: (_: unknown, record: Message) =>
                record.is_template_match ? <Tag color='volcano'>Campaign</Tag> : null,
        },
        {
            title: 'Received',
    ...
    const mockData: Message[] = [
        {
            ...
            analysis: {
                ...
                message_id: '1',
                tones: [
                    { label: 'grateful', confidence: 0.85 },
                    { label: 'polite', confidence: 0.72 },
                ],
                sentiment_score: 0.5,
        ...
        },
        {
            ...
            analysis: {
                ...
                message_id: '2',
                tones: [
                    { label: 'frustrated', confidence: 0.9 },
                    { label: 'demanding', confidence: 0.65 },
                ],
                sentiment_score: -0.7,
        ...
        },
        {
            ...
            analysis: {
                ...
                message_id: '3',
                tones: [
                    { label: 'formal', confidence: 0.88 },
                    { label: 'cordial', confidence: 0.75 },
                ],
                sentiment_score: 0.1,
                ...
                <Row gutter={[16, 16]} align='middle'>
                    ...
                    <Col xs={24} sm={12} md={8} lg={4}>
                        <Select
                            ...
                            onChange={(value) => setMessageFilters({ ...messageFilters, source: value })}
                            allowClear
                            options={[
                    ...
                    <Col xs={24} sm={12} md={8} lg={4}>
                        <Select
                            ...
                            onChange={(value) => setMessageFilters({ ...messageFilters, sentiment: value })}
                            allowClear
                            options={[
                    ...
                    <Col>
                        <Space>
                            <Button icon={<FilterOutlined />} onClick={() => setMessageFilters({})}>
                                Clear
                            </Button>
